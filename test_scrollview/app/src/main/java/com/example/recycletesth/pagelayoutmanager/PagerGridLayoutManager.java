package com.example.recycletesth.pagelayoutmanager;
...
public class PagerGridLayoutManager extends RecyclerView.LayoutManager
  ...
  private final String TAG = "PagerGridLayoutManager";
...
//    Logger.i(TAG,"Item onLayoutChildren");
//    Logger.i(TAG,"Item onLayoutChildren isPreLayout = " + state.isPreLayout());
//    Logger.i(TAG,"Item onLayoutChildren isMeasuring = " + state.isMeasuring());
//    Logger.i(TAG,"Item onLayoutChildren state = " + state);
...
//    Logger.i(TAG,"count = " + getItemCount());
...
//    Logger.i(TAG,"mOffsetX = " + mOffsetX);
//    Logger.i(TAG,"mOffsetY = " + mOffsetY);
...
//    Logger.i(TAG,"child count = " + getChildCount());
  }
...
//    Logger.i(TAG,"onScrollStateChanged = " + state);
    mScrollState = state;
  ...
  private Rect getItemFrameByPosition(int pos) {
    ...
    if (null == rect) {
      ...
      // 状态输出，用于调试
//      Logger.i(TAG,"pagePos = " + pagePos);
//      Logger.i(TAG,"行 = " + row);
//      Logger.i(TAG,"列 = " + col);
//
//      Logger.i(TAG,"offsetX = " + offsetX);
//      Logger.i(TAG,"offsetY = " + offsetY);
...
//    Logger.i(TAG,"getPageIndexByOffset pageIndex = " + pageIndex);
    return pageIndex;
  }
...
//    Logger.i(TAG,"computeScrollVectorForPosition next = " + page);
  ...
  int findPrePageFirstPos() {
    ...
    int page = mLastPageIndex;
    page--;
//    Logger.i(TAG,"computeScrollVectorForPosition pre = " + page);
    if (page < 0) {
      page = 0;
    }
//    Logger.i(TAG,"computeScrollVectorForPosition pre = " + page);
...
//    Logger.i(TAG,"setPageIndex = " + pageIndex + ":" + isScrolling);
...
//      Logger.i(TAG, "pageIndex is outOfIndex, must in [0, " + mLastPageCount + ").");
      return;
    }
    if (null == mRecyclerView) {
//      Logger.i(TAG, "RecyclerView Not Found!");
      return;
    }
  ...
  public void scrollToPage(int pageIndex) {
    if (pageIndex < 0 || pageIndex >= mLastPageCount) {
//      Logger.i(TAG, "pageIndex = " + pageIndex + " is out of bounds, mast in [0, " + mLastPageCount + ")");
      return;
    }
...
//    Logger.i(TAG,"mTargetOffsetXBy = " + mTargetOffsetXBy);
//    Logger.i(TAG,"mTargetOffsetYBy = " + mTargetOffsetYBy);
